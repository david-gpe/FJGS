...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
		...
		<a class="navbar-brand" href="#">
			<img src="img/escudo.jpg" width="80" height="80" alt="">
		...
		<div class="modal fade" id="ModalVis" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					    ...
					    <div class="modal-body">
					        <h4 class="text-justify"><small>
					        	Ser una escuela activa, abierta a la innovación y al cambio haciendo uso de habilidades tecnológicas y nuevas propuestas educativas, formadora de alumnos responsables, respetuosos, lideres analíticos y propositivos en la sociedad.</small></h4>
					    </div>
					    <div class="modal-footer">
					        <button type="button" class="btn btn-primary" data-dismiss="modal">Cerrar</button>
					    </div>
...
<!-- Colocar algo para que la se vea bonito-->
				    ...
				    <tr>
				        <th>
				            <content class="format">
								...
								<h4>coloca una imagen para que no se vea tan solo esto</h4>
				        </th>
				     	<th>
				        	<form class="form-register" action="bd/login.php" method="POST">
								<div class="form-row">
								...
								<div class="form-row">
									<div class="form-row ml-auto">
										<button type="submit" class="botonlg btn btn-primary" data-dismiss="modal">Enviar correo de recuperación</button>
					      	    	</div>
						 		</div>
						 		<div class="form-row">
									<div class="form-row ml-auto">
					      	    		<a class="form-row ml-auto" href="loginindex.php"> Volver a inicio de sesión</a>
					      	    	</div>
						 		</div>
							</form>
				    	</th>
